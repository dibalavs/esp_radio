...
#define PIN_SPI_MISO GPIO_NUM_19 	// Master Input, Slave Output
#define PIN_SPI_MOSI GPIO_NUM_23	// Master Output, Slave Input   Named Data or SDA or D1 for oled
#define PIN_SPI_CLK  GPIO_NUM_18 	// Master clock  Named SCL or SCK or D0 for oled
